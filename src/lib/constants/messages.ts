...
export const MESSAGES = {
  ...
  'auth.invalidOrExpiredToken': 'توکن نامعتبر یا منقضی شده',
  'auth.tokenAlreadyUsed': 'توکن قبلاً استفاده شده',
  'auth.tokenExpired': 'توکن منقضی شده',
  'auth.passwordMinLength': 'رمز عبور باید حداقل ۸ کاراکتر باشد',
  'auth.passwordResetRequested': 'درخواست بازنشانی رمز عبور',
  'auth.passwordResetCompleted': 'بازنشانی رمز عبور تکمیل شد',
  'auth.passwordResetSent': 'اگر ایمیل در سیستم موجود باشد، لینک بازنشانی ارسال شد',
  'auth.passwordResetSuccess': 'رمز عبور با موفقیت تغییر کرد',
  'auth.passwordResetByAdmin': 'رمز عبور توسط مدیر تغییر کرد',
  'auth.rateLimit': 'تعداد تلاش‌ها زیاد است. لطفاً بعداً دوباره تلاش کنید',
  'auth.loggedOut': 'خارج شدید',
  'auth.tokenAndPasswordRequired': 'توکن و رمز عبور جدید الزامی است',
